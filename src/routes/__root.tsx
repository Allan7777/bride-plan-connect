  ...
  head: () => ({
    meta: [
      ...
      { title: "NoivaHub — Seu casamento começa aqui" },
      {
        name: "description",
        content:
          "Organize seu casamento e encontre fotógrafos, maquiadores, cerimonialistas, DJs e buffets em um só lugar.",
      },
      { property: "og:title", content: "NoivaHub — Seu casamento começa aqui" },
      {
        property: "og:description",
        content: "Planejamento de casamento e marketplace de fornecedores.",
      },
